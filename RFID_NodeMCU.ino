...
const char *ssid = "STUDYVILLE";  //ENTER YOUR WIFI SETTINGS
const char *password = "99988877";

//Web/Server address to read/write from
const char *host = "192.168.0.249";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.0.249/loginsystem/postdemo.php" + getData;
